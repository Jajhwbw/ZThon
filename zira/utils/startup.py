...
Zed_Vip = (6300938349, 7098821848, 627658332)
zchannel = {"@ucriss"}
...
async def mybot(): #Code by T.me/zzzzl1l
    ...
    if bot_name.startswith("مسـاعـد"):
        ...
        try:
            ...
            await asyncio.sleep(1)
            await bot.send_message("@BotFather", "zein")
    ...
    try:
        if BOTLOG:
            Config.ZEDUBLOGO = await zedub.tgbot.send_file(
                BOTLOG_CHATID,
                "https://telegra.ph/file/c594786a4b3e66797ac1d.mp4",
                caption="**•⎆┊تـم بـدء تشغـيل سـورس ايــڪاࢪ الخاص بك .. بنجاح 🧸♥️**",
                buttons=[(Button.url("༺ sourCe Ꭵkαᖇ ༻", "https://t.me/ucriss"),)],
            )
    except Exception as e:
        LOGS.error(e)
        return None
...
async def verifyLoggerGroup():
    ...
    if BOTLOG:
        ...
        _, groupid = await create_supergroup(
            "كـروب السجـل ايــڪاࢪ", zedub, Config.TG_BOT_USERNAME, descript, photozed
        )
