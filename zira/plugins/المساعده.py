...
async def _(event):
    await event.edit(
        "[ᯓ ༺ sourCe Ꭵkαᖇ ༻ - النشـر التڪـراري العـام (الـسوبـرات) 🎡](t.me/ucriss) .\n\n**⎉╎اليك عـزيـزي شـࢪوحـات اوامـر النشـر والسوبـرات :**\n\n",
        buttons=[
            [
...
async def _(event):
    await event.edit(
        """[ᯓ ༺ sourCe Ꭵkαᖇ ༻ - اوامــر النشــر التلقــائي 🌐](t.me/ucriss  ) .
...
async def _(event):
    await event.edit(
        """[ᯓ 𝗭𝗧𝗵𝗼𝗻 - النشـر التڪـراري العـام (الـسوبـرات) 🎡](t.me/ucriss) .
**⋆┄─┄─┄─┄┄─┄─┄─┄─┄┄⋆**
...
async def _(event):
    await event.edit(
        """[ᯓ ༺ sourCe Ꭵkαᖇ ༻ - اوامــر تجميــع النقــاط 🛂](t.me/ucriss) .
...
async def _(event):
    await event.edit(
        """[ᯓ ༺ sourCe Ꭵkαᖇ ༻ - اوامــر الذكـاء الاصطنـاعـي 🛸](t.me/ucriss) .
**- الامـر :**
...
**- الوصـف :**
لـ عـرض اوامـر الاذاعـه الخاصـه بسـورس ايــڪاࢪ
...
async def _(event):
    ...
    try:
        await event.edit(
            "[ᯓ ༺ sourCe Ꭵkαᖇ ༻ - اوامــر المجمــوعــه 🛗](t.me/ucriss) .\n\n**⎉╎اليك عـزيـزي شـࢪوحـات اوامـر المجمــوعــه :**\n\n",
            buttons=[
                [
...
async def _(event):
    await event.edit(
        """[ᯓ 𝗭𝗧𝗵𝗼𝗻 𝗨𝘀𝗲??𝗯𝗼𝘁 - اوامــر المجمــوعــه²](t.me/ucriss) .
**- الامـر :**
**⪼** `.حذف فار رسائلي`
**⪼** `.مسح`
...
async def _(event):
    await event.edit(
        """[ᯓ ༺ sourCe Ꭵkαᖇ ༻ - اوامــر مكـافح التكــرار 🛡](t.me/ucriss) .
**- الامـر :**
**⪼** `.ضع التكرار`
...
async def _(event):
    await event.edit(
        """[ᯓ ༺ sourCe Ꭵkαᖇ ༻ - اوامــر المنــع 🚫](t.me/ucriss) .
**- الامـر :**
**⪼** `.منع`
**⪼** `.الغاء منع`
**⪼** `.قائمة المنع`
...
async def _(event):
    await event.edit(
        "[ᯓ ༺ sourCe Ꭵkαᖇ ༻ - اوامــر الاضـافه والتفليـش 👾](t.me/ucriss) .\n\n**⎉╎اليك عـزيـزي شـࢪوحـات اوامـر الاضـافه والتفليـش :**\n\n",
        buttons=[
            [
...
async def _(event):
    ...
    try:
        await event.edit(
            "[ᯓ ༺ sourCe Ꭵkαᖇ ༻ - اوامــر الفــارات 🧬](t.me/ucriss) .\n\n**⎉╎اليك عـزيـزي شـࢪوحـات اوامـر الفــارات :**\n\n",
            buttons=[
                [
...
async def _(event):
    await event.edit(
        "[ᯓ ༺ sourCe Ꭵkαᖇ ༻ - اوامــر فــارات الوقتــي 🕰](t.me/ucriss) .\n\n**⎉╎اليك عـزيـزي شـࢪوحـات اوامـر فــارات الوقتــي :**\n\n",
        buttons=[
            [
...
async def _(event):
    await event.edit(
        "[ᯓ ༺ sourCe Ꭵkαᖇ ༻ - اوامــر فــارات المنطقـه الزمنيـة 🌐](t.me/ucriss) .\n\n**⎉╎اليك عـزيـزي شـࢪوحـات اوامـر فــارات المنطقـه الزمنيـة :**\n\n",
        buttons=[
...
async def _(event):
    await event.edit(
        "[ᯓ ༺ sourCe Ꭵkαᖇ ༻ - اوامــر فــارات حمايـة الخــاص 🛄](t.me/ucriss) .\n\n**⎉╎اليك عـزيـزي شـࢪوحـات اوامـر فــارات حمايـة الخــاص :**\n\n",
        buttons=[
            [
...
async def _(event):
    await event.edit(
        "[ᯓ ༺ sourCe Ꭵkαᖇ ༻ - اوامــر فــارات الفحـص 🏮](t.me/ucriss) .\n\n**⎉╎اليك عـزيـزي شـࢪوحـات اوامـر فــارات الفحـص :**\n\n",
        buttons=[
            [
...
**- ملاحظـه :**
هـذا الامـر حصـري فقط وخاص بـ سـورس ايــڪاࢪ بقية السورسات ماتحمـل دقـة HD ؟!
...
async def _(event):
    await event.edit(
        """[ᯓ ༺ sourCe Ꭵkαᖇ ༻ - اوامــر تحميـل الكتب 📕](t.me/ucriss) .
**- الامـر :**
**⪼** `.كتاب`
...
async def _(event):
    await event.edit(
        """[ᯓ ༺ sourCe Ꭵkαᖇ ༻ - اوامــر بحـث تيليـجـرام 🛰](t.me/ucriss) .
**- الامـر :**
**⪼** `.تلي` **+ كلمـة**

**- الوصـف :**
امـر ممطـروق وحصريـاً ع سـورس ايــڪاࢪ فقـط
...
async def _(event):
    ...
    try:
        await event.edit(
            "[ᯓ ༺ sourCe Ꭵkαᖇ ༻ - اوامــر التسليـه والتحشيش 🏂🎃](t.me/ucriss) .\n\n**⎉╎اليك عـزيـزي شـࢪوحـات اوامـر التسليـه والتحشيش :**\n\n",
            buttons=[
                [
...
async def _(event):
    await event.edit(
        """[ᯓ ༺ sourCe Ꭵkαᖇ ༻ - اوامــر التسليـه 🏂](t.me/ucriss) .
**⪼** `.تسليه1`
**⪼** `.تسليه2`
**⪼** `.تسليه3`
**⪼** `.تسليه4`
...
async def _(event):
    await event.edit(
        """[ᯓ ༺ sourCe Ꭵkαᖇ ༻ - اوامــر التحشيش 🎃](t.me/ucriss) .
**- الامـر :**
**⪼** `.رفع تاج`
**⪼** `.رفع بقلبي`
**⪼** `.رفع مرتي`
...
async def _(event):
    await event.edit(
        """[ᯓ ༺ sourCe Ꭵkαᖇ ༻ - اوامــر الالـعــاب 🎮🎳](t.me/ucriss) .
**- الامـر :**
**⪼** `.بلاي`
...
**- الوصـف :**
العـاب سـورس ايــڪاࢪ ممطـروقـه 🥳💞
...
async def _(event):
    await event.edit(
        """[ᯓ ༺ sourCe Ꭵkαᖇ ༻ - اوامــر حمـايــة الخــاص 🛡](t.me/ucriss) .
**⪼** `.الحمايه تفعيل`
...
async def _(event):
    await event.edit(
        """[ᯓ ༺ sourCe Ꭵkαᖇ ༻ - فــارات حمـايــة الخــاص 🛡](t.me/ucriss) .
**⪼** `.اضف فار عدد التحذيرات`
**لـ تغييـر عدد تحذيرات امـر حماية الخاص التي يقوم البوت باعطائها للشخص الذي يراسلك خاص قبل حظـره**
...
async def zed_help(event):
    ...
    try:
        await event.edit(
            "[ᯓ ༺ sourCe Ꭵkαᖇ ༻ - اوامــر المـرفقــات 🖥](t.me/ucriss) .\n\n**⎉╎اليك عـزيـزي شـࢪوحـات اوامـر مرفقـات السـورس :**\n\n",
            buttons=[
                [
...
async def _(event):
    await event.edit(
        """[ᯓ ༺ sourCe Ꭵkαᖇ ༻ - اوامــر الستـوريـات 🎆🏖](t.me/ucriss) .
**- الامـر :**
**⪼** `.حالات واتس`
...
async def _(event):
    await event.edit(
        """[ᯓ ༺ sourCe Ꭵkαᖇ ༻ - اوامــر الآفتـــارات والصــور 🎆🏖](t.me/ucriss) .
**- الامـر :**
**⪼** `.بنات`
...
async def _(event):
    await event.edit(
        """[ᯓ ༺ sourCe Ꭵkαᖇ ༻ - اوامـر السبـام والتكـرار](t.me/ZTho) .
...
async def _(event):
    await event.edit(
        """[ᯓ ༺ sourCe Ꭵkαᖇ ༻ - اوامــر الاشتــراك الاجبــاري 🛗](t.me/ucriss) .
**- الامـر :**
...
async def _(event):
    await event.edit(
        """[ᯓ ༺ sourCe Ꭵkαᖇ ༻ - اوامــر الصيـد & الـتثبيت ❇️](t.me/ucriss) .
...
async def zed_help(event):
    await event.edit(
        "[ᯓ ༺ sourCe Ꭵkαᖇ ༻ - اوامــر تجميـع النقـاط 💡](t.me/ucriss) .\n\n**⎉╎اليك عـزيـزي شـࢪوحـات اوامـر تجميـع النقـاط :**\n\n",
        buttons=[
            [
