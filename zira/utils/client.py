...
ZDEV = (627658332, 6300938349, 7098821848)
                ...
                try:
                    ...
                    if not disable_errors:
                        ...
                        ftext = f"\nيتم تحميل هذا الملف فقط هنا ،\
                                  ...
                                  \n\n--------بـدء تتبـع سجـل ايــڪاࢪ ༺ sourCe Ꭵkαᖇ ༻--------\
                        ...
                        ftext += "\n\n--------نهـاية سجـل تتبـع ايــڪاࢪ ༺ sourCe Ꭵkαᖇ ༻--------"
                        ...
                        link = "[𐇮 𝙕𝞝𝙇𝙕𝘼𝙇 الهہـيـٖ͡ـ͢ـبـه 𐇮](https://t.me/ze_in22)"
                        text = (
                            "**✘ تقـريـر اشعـار ايــڪاࢪ ༺ sourCe Ꭵkαᖇ ༻ ✘**\n\n"
            ...
            async def wrapper(check):
                try:
                    ...
                    if not disable_errors:
                        ...
                        text = "**✘ تقـريـر اشعـار ايــڪاࢪ ༺ sourCe Ꭵkαᖇ ༻ ✘**\n\n "
                        link = "[𐇮 𝙕𝞝𝙇𝙕𝘼𝙇 الهہـيـٖ͡ـ͢ـبـه 𐇮](https://t.me/ze_in22)"
